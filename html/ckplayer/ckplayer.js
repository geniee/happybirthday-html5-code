...
(function() {
    var CKobject = {
		...
		_I_: null,
		_O_: {},
		uaMatch:function(u,rMsie,rFirefox,rOpera,rChrome,rSafari){
		...
		browser: function() {
			...
			var v;
			var c = u.toLowerCase();
			var d = this.uaMatch(c,rMsie,rFirefox,rOpera,rChrome,rSafari);
			if (d.b) {
				b = d.b;
				v = d.v;
			}
